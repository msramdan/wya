...
Route::get('getEquipment/{locationId}', [App\Http\Controllers\EquipmentController::class, 'getEquipment'])->name('api.getEquipment');
Route::get('getEquipmentByBarcode/{barcode}', [App\Http\Controllers\EquipmentController::class, 'getEquipmentByBarcode'])->name('api.getEquipmentByBarcode');
