...
return [
    ...
    'permissions' => [
        ...
        ['group' => 'setting apps', 'access' => ['setting app view','setting app edit']],['group' => 'unit items', 'access' => ['unit item view', 'unit item create', 'unit item edit', 'unit item delete']],['group' => 'equipment locations', 'access' => ['equipment location view', 'equipment location create', 'equipment location edit', 'equipment location delete']],['group' => 'equipment categories', 'access' => ['equipment category view', 'equipment category create', 'equipment category edit', 'equipment category delete']],['group' => 'provinces', 'access' => ['province view', 'province create', 'province edit', 'province delete']],['group' => 'kabkots', 'access' => ['kabkot view', 'kabkot create', 'kabkot edit', 'kabkot delete']],['group' => 'kecamatans', 'access' => ['kecamatan view', 'kecamatan create', 'kecamatan edit', 'kecamatan delete']],['group' => 'kelurahans', 'access' => ['kelurahan view', 'kelurahan create', 'kelurahan edit', 'kelurahan delete']],['group' => 'employee types', 'access' => ['employee type view', 'employee type create', 'employee type edit', 'employee type delete']], 
		],];