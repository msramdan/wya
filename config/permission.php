...
return [
    ...
    'permissions' => [
        ...
        ['group' => 'unit items', 'access' => ['unit item view', 'unit item create', 'unit item edit', 'unit item delete']],
        ['group' => 'equipment locations', 'access' => ['equipment location view', 'equipment location create', 'equipment location edit', 'equipment location delete']], ['group' => 'equipment categories', 'access' => ['equipment category view', 'equipment category create', 'equipment category edit', 'equipment category delete']],
        ...
        ['group' => 'hospitals', 'access' => ['hospitals view', 'hospitals create', 'hospitals edit', 'hospitals delete', 'hospitals approval', 'hospitals process']],
    ],
];
