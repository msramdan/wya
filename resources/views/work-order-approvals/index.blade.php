            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">{{ trans('work-order/approval/index.head') }}</h4>
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="/panel">Dashboard</a></li>
                                <li class="breadcrumb-item active">{{ trans('work-order/approval/index.head') }}</li>
                            </ol>
                        </div>
...
@push('js')
    ...
    <script>
        ...
        var table = $('#data-table').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: "{{ route('work-order-approvals.index') }}?user_id={{ Auth::user()->id }}",
                data: function(s) {
