                    ...
                    <tbody>
                        ...
                        @else
                            @forelse ($workOrderProcesess->calibrationPerformance as $index => $calibrationPerformance)
                                <tr data-index="{{ $index }}">
                                    <td>
                                        <button type="button" class="btn btn-sm btn-{{ $index == 0 ? 'primary' : 'danger' }}" @if ($index == 0) onclick="addRowPerformanceCalibration(this.parentElement.parentElement)"
                                    @else
                                    onclick="this.parentElement.parentElement.remove()" @endif><i class="fa fa-{{ $index == 0 ? 'plus' : 'trash' }}"></i></button>
                                    </td>
                                    <td>
                                        <div class="form-group">
                                            <input type="text" autocomplete="off" placeholder="Tool Performance Check" name="calibration_performance_tool_performance_check[{{ $index }}]" class="form-control" id="tool_performance_check_{{ $index }}" value="{{ $calibrationPerformance->tool_performance_check }}">
                                        </div>
                                    </td>
                                    <td>
                                        <div class="form-group">
                                            <input type="text" autocomplete="off" placeholder="Setting" name="calibration_performance_setting[{{ $index }}]" class="form-control" id="setting_{{ $index }}" value="{{ $calibrationPerformance->setting }}">
                                        </div>
                                    </td>
                                    <td>
                                        <div class="form-group">
                                            <input type="text" autocomplete="off" placeholder="Measurable" name="calibration_performance_measurable[{{ $index }}]" class="form-control" id="measurable_{{ $index }}" value="{{ $calibrationPerformance->measurable }}">
                                        </div>
                                    </td>
                                    <td>
                                        <div class="form-group">
                                            <input type="text" autocomplete="off" placeholder="Reference Value" name="calibration_performance_reference_value[{{ $index }}]" class="form-control" id="reference_value_{{ $index }}" value="{{ $calibrationPerformance->reference_value }}">
                                        </div>
                                    </td>
                                    <td class="text-center">
                                        <div class="d-flex justify-content-center">
                                            <input type="radio" name="calibration_performance_is_good[{{ $index }}]" class="form-check" value="1" {{ $calibrationPerformance->is_good == '1' ? 'checked' : '' }}>
                                        </div>
                                    </td>
                                    <td class="text-center">
                                        <div class="d-flex justify-content-center">
                                            <input type="radio" name="calibration_performance_is_good[{{ $index }}]" class="form-check" value="0" {{ $calibrationPerformance->is_good == '0' ? 'checked' : '' }}>
                                        </div>
                                    </td>
                                </tr>
                            @empty
                                <tr data-index="0">
                                    <td>
                                        <button type="button" class="btn btn-sm btn-primary" onclick="addRowPerformanceCalibration(this.parentElement.parentElement)"><i class="fa fa-plus"></i></button>
                                    </td>
                                    <td>
                                        <div class="form-group">
                                            <input type="text" autocomplete="off" placeholder="Tool Performance Check" name="calibration_performance_tool_performance_check[0]" class="form-control" id="tool_performance_check_0">
                                        </div>
                                    </td>
                                    <td>
                                        <div class="form-group">
                                            <input type="text" autocomplete="off" placeholder="Setting" name="calibration_performance_setting[0]" class="form-control" id="setting_0">
                                        </div>
                                    </td>
                                    <td>
                                        <div class="form-group">
                                            <input type="text" autocomplete="off" placeholder="Measurable" name="calibration_performance_measurable[0]" class="form-control" id="measurable_0">
                                        </div>
                                    </td>
                                    <td>
                                        <div class="form-group">
                                            <input type="text" autocomplete="off" placeholder="Reference Value" name="calibration_performance_reference_value[0]" class="form-control" id="reference_value_0">
                                        </div>
                                    </td>
                                    <td class="text-center">
                                        <div class="d-flex justify-content-center">
                                            <input type="radio" name="calibration_performance_is_good[0]" class="form-check" value="1">
                                        </div>
                                    </td>
                                    <td class="text-center">
                                        <div class="d-flex justify-content-center">
                                            <input type="radio" name="calibration_performance_is_good[0]" class="form-check" value="0">
                                        </div>
                                    </td>
                                </tr>
                            @endforelse
