                ...
                <table class="table">
                    ...
                    <tbody>
                        @forelse ($workOrderProcesess->functionChecks as $index => $item)
                            <tr data-index="{{ $index }}">
                                <td>
                                    <button class="btn btn-sm btn-{{ $index == 0 ? 'primary' : 'danger' }}" @if ($index == 0) onclick="addRowFunctionCheck(this.parentElement.parentElement)"
                                @else
                        ...
                        @empty
                            <tr data-index="0">
                                <td>
                                    <button class="btn btn-sm btn-primary" onclick="addRowFunctionCheck(this.parentElement.parentElement)"><i class="fa fa-plus"></i></button>
                                </td>
                                <td>
                                    <div class="form-group">
