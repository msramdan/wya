                ...
                <table class="table" id="table-fungsi">
                    ...
                    <tbody>
                        @forelse ($workOrderProcesess->equipmentInspectionChecks as $index => $item)
                            <tr data-index="{{ $index }}">
                                <td>
                                    <button class="btn btn-sm btn-{{ $index == 0 ? 'primary' : 'danger' }}" @if ($index == 0) onclick="addRowEquipmentInspectionCheck(this.parentElement.parentElement)"
                                @else
                        ...
                        @empty
                            <tr data-index="0">
                                <td>
                                    <button class="btn btn-sm btn-primary" onclick="addRowEquipmentInspectionCheck(this.parentElement.parentElement)"><i class="fa fa-plus"></i></button>
                                </td>
                                <td>
                                    <div class="form-group">
