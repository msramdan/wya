    ...
    <div class="col-md-6">
        <div class="row">
            <div class="col-12 mb-3">
                ...
                <input type="text" name="aplication_name" id="aplication-name" class="form-control @error('aplication_name') is-invalid @enderror" value="{{ isset($settingApp) ? $settingApp->aplication_name : old('aplication_name') }}" placeholder="{{ __('Aplication Name') }}" required />
            ...
            <div class="col-12 mb-3">
                @if ($settingApp->logo != '' || $settingApp->logo != null)
                    <img style="width: 180px; height:80px" src="{{ Storage::url('public/img/setting_app/') . $settingApp->logo }}" class="">
        ...
        <div class="row">
            ...
            <div class="col-12 mb-3">
                @if ($settingApp->favicon != '' || $settingApp->favicon != null)
                    <img style="width:80px;height:80px" src="{{ Storage::url('public/img/setting_app/') . $settingApp->favicon }}" class="">
