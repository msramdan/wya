                    ...
                    <div class="d-flex">
                        {{-- <div class="navbar-brand-box horizontal-logo">
                            <a href="#" class="logo logo-dark">
                                ...
                                <span class="logo-lg">
                                    <img src="{{ asset('material/assets/images/logo-dark.png') }}" alt=""
                                        height="17">
                                </span>
                            </a>
                                ...
                                <div class="tab-content" id="notificationItemsTabContent">
                                    <div class="tab-pane fade show active py-2 ps-2" id="all-noti-tab"
                                        ...
                                        <div data-simplebar style="max-height: 300px;" class="pe-2">
                                            ...
                                            <div
                                                ...
                                                <div class="d-flex">
                                                    <img src="{{ asset('material/assets/images/users/avatar-2.jpg') }}"
                                            ...
                                            <div
                                                class="text-reset notification-item d-block dropdown-item position-relative">
                                                <div class="d-flex">
                                                    <img src=" {{ asset('material/assets/images/users/avatar-8.jpg') }}"
                                                        class="me-3 rounded-circle avatar-xs" alt="user-pic">
                                                    <div class="flex-1">
                                                        <a href="#!" class="stretched-link">
                                    ...
                                    <div class="tab-pane fade p-4" id="alerts-tab" role="tabpanel"
                                        ...
                                        <div class="w-25 w-sm-50 pt-3 mx-auto">
                                            <img src="{{ asset('material/assets/images/svg/bell.svg') }}"
