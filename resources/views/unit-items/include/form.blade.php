<div class="row mb-2">
    <div class="col-md-6 mb-2">
        <label for="code-unit">Kode Unit Item</label>
        <input type="text" name="code_unit" id="code-unit"
            ...
            placeholder="Kode Unit Item" required />
        @error('code_unit')
    ...
    <div class="col-md-6 mb-2">
        <label for="unit-name">Nama Unit Item</label>
        <input type="text" name="unit_name" id="unit-name"
            ...
            placeholder="Nama Unit Item" required />
        @error('unit_name')
            <span class="text-danger">
                {{ $message }}
            </span>
