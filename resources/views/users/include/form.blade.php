            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    <input type="password" name="password" id="password"
                        ...
                        placeholder="{{ trans('utilities/users/form.password') }}"
                        {{ empty($user) ? 'required' : '' }}>
                    &nbsp;
        ...
        @empty($user)
            <div class="col-md-12 mb-2">
                <div class="form-group">
                    ...
                    <select class="form-select js-example-basic-multiple" name="role" id="role" class="form-control"
                        required>
                        <option value="" selected disabled>-- {{ trans('utilities/users/form.select_role') }} --
                        </option>
                        @foreach ($roles as $role)
                ...
                <div class="avatar avatar-xl">
                    @if ($user->avatar == null)
                        <img src="https://www.gravatar.com/avatar/{{ md5(strtolower(trim($user->email))) }}&s=450"
                            alt="avatar">
                    @else
                        <img style="width: 70%" class="img-thumbnail"
                            src="{{ asset("uploads/images/avatars/$user->avatar") }}" alt="avatar">
                    @endif
                </div>
            </div>
