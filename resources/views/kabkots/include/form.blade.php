<div class="row mb-2">
    ...
    <div class="col-md-6 mb-2">
        ...
        <input type="text" name="kabupaten_kota" id="kabupaten-kotum"
            ...
            placeholder="{{ __('Kabupaten Kota') }}" required />
    ...
    <div class="col-md-6 mb-2">
        ...
        <input type="text" name="ibukota" id="ibukotum" class="form-control @error('ibukota') is-invalid @enderror"
            value="{{ isset($kabkot) ? $kabkot->ibukota : old('ibukota') }}" placeholder="{{ __('Ibukota') }}"
            required />
        @error('ibukota')
            <span class="text-danger">
                {{ $message }}
    ...
    <div class="col-md-6 mb-2">
        ...
        <input type="text" name="k_bsni" id="k-bsni" class="form-control @error('k_bsni') is-invalid @enderror"
            value="{{ isset($kabkot) ? $kabkot->k_bsni : old('k_bsni') }}" placeholder="{{ __('K Bsni') }}"
            required />
        @error('k_bsni')
            <span class="text-danger">
                {{ $message }}
