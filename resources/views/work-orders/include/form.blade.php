                ...
                <div class="row">
                    <div class="col-md-6 mb-2">
                        ...
                        <input type="text" name="wo_number" id="wo_number" readonly
                            ...
                            value="{{ isset($workOrder) && $workOrder->wo_number ? $workOrder->wo_number : old('wo_number') }}"
                ...
                <div class="row">
                    ...
                    <div class="col-md-8 mb-2">
                        ...
                        <select
                            ...
                            name="equipment_id" id="location_id" required>
                ...
                <div class="row">
                    <div class="col-md-6 mb-2">
                        ...
                        <input type="date" name="schedule_date" id="schedule-date"
                            ...
                            placeholder="{{ __('Schedule Date') }}" required />
                        @error('schedule_date')
                            <span class="text-danger">
                                {{ $message }}
                            </span>
                    ...
                    <div class="col-md-6 mb-2">
                        <label for="schedule-date">{{ __('Schedule Wo') }}</label>
                        <select
                            class="form-control js-example-basic-multiple @error('category_wo') is-invalid @enderror"
                            name="category_wo" id="category-wo" required>
                            <option value="" selected disabled>-- {{ __('Select schedule wo') }} --</option>
                            <option value="Harian"
                                {{ isset($workOrder) && $workOrder->category_wo == 'Harian' ? 'selected' : (old('category_wo') == 'Harian' ? 'selected' : '') }}>
                                {{ __('Harian') }}</option>
                            <option value="Mingguan"
                                {{ isset($workOrder) && $workOrder->category_wo == 'Mingguan' ? 'selected' : (old('category_wo') == 'Mingguan' ? 'selected' : '') }}>
                                {{ __('Mingguan') }}</option>
                            <option value="Bulanan"
                                {{ isset($workOrder) && $workOrder->category_wo == 'Bulanan' ? 'selected' : (old('category_wo') == 'Bulanan' ? 'selected' : '') }}>
                                {{ __('Bulanan') }}</option>
                            <option value="2 Bulanan"
                                {{ isset($workOrder) && $workOrder->category_wo == '2 Bulanan' ? 'selected' : (old('category_wo') == '2 Bulanan' ? 'selected' : '') }}>
                                {{ __('2 Bulanan') }}</option>
                            <option value="3 Bulanan"
                                {{ isset($workOrder) && $workOrder->category_wo == '3 Bulanan' ? 'selected' : (old('category_wo') == '3 Bulanan' ? 'selected' : '') }}>
                                {{ __('3 Bulanan') }}</option>
                            <option value="4 Bulanan"
                                {{ isset($workOrder) && $workOrder->category_wo == '4 Bulanan' ? 'selected' : (old('category_wo') == '4 Bulanan' ? 'selected' : '') }}>
                                {{ __('4 Bulanan') }}</option>
                            <option value="6 Bulanan"
                                {{ isset($workOrder) && $workOrder->category_wo == '6 Bulanan' ? 'selected' : (old('category_wo') == '6 Bulanan' ? 'selected' : '') }}>
                                {{ __('6 Bulanan') }}</option>
                            <option value="Tahunan"
                                {{ isset($workOrder) && $workOrder->category_wo == 'Tahunan' ? 'selected' : (old('category_wo') == 'Tahunan' ? 'selected' : '') }}>
                                {{ __('Tahunan') }}</option>
                        </select>
                        @error('schedule_date')
                            <span class="text-danger">
                    ...
                    <div class="col-md-6 mb-2">
                        <label for="schedule-date">{{ __('Start Date') }}</label>
                        <input type="date" name="schedule_date" id="schedule-date"
                            class="form-control @error('schedule_date') is-invalid @enderror"
                            value="{{ isset($workOrder) && $workOrder->schedule_date ? $workOrder->schedule_date->format('Y-m-d') : old('schedule_date') }}"
                            placeholder="{{ __('Schedule Date') }}" required />
                    ...
                    <div class="col-md-6 mb-2">
                        <label for="schedule-date">{{ __('End Date') }}</label>
                        <input type="date" name="schedule_date" id="schedule-date"
                            class="form-control @error('schedule_date') is-invalid @enderror"
                            value="{{ isset($workOrder) && $workOrder->schedule_date ? $workOrder->schedule_date->format('Y-m-d') : old('schedule_date') }}"
                            placeholder="{{ __('Schedule Date') }}" required />
