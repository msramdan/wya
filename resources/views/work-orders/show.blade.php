    ...
    <div class="page-body">
        <div class="container-fluid">
            <div class="page-header" style="margin-top: 5px">
                <div class="row">
                    <div class="col-sm-6">
                        <h3>{{ trans('work-order/submission/index.head') }}</h3>
                        <ol class="breadcrumb">
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ isset($workOrder->filed_date) ? $workOrder->filed_date->format('d/m/Y') : '' }}
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ isset($workOrder->schedule_date) ? $workOrder->schedule_date->format('d/m/Y') : '' }}
                                        </td>
                                    </tr>
                                    <tr>
